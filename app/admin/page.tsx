    ...
    return (
      <div dir="rtl" style={{
        ...
        <div style={{
          ...
          <input type="password" placeholder="كلمة السر" value={pass} onChange={e => setPass(e.target.value)}
      ...
      <div style={{ maxWidth: 1100, margin: "0 auto" }}>
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 32 }}>
          ...
          <div style={{ display: "flex", gap: 12 }}>
            <button onClick={() => { fetchBookings(); fetchClients(); }} style={{
        ...
        <div style={{ display: "flex", gap: 8, marginBottom: 24 }}>
          {[
            ...
            <button key={t.id} onClick={() => setActiveSection(t.id)} style={{
              ...
              border: `1px solid ${activeSection === t.id ? COLORS.accent : COLORS.border}`,
            }}>{t.label}</button>
          ))}
        </div>
              ...
              clients.map((c, i) => (
                <div key={i} style={{
                  ...
                  <div>
                    <span style={{
                      fontSize: 11, padding: "4px 10px", borderRadius: 20, fontWeight: 600,
                      background: c.is_active ? "#00d4aa22" : "#ef444422",
                      color: c.is_active ? "#00d4aa" : "#ef4444",
                      border: `1px solid ${c.is_active ? "#00d4aa44" : "#ef444444"}`,
                    }}>{c.is_active ? "✅ مفعّل" : "⏳ انتظار الدفع"}</span>
                  </div>
                  <div>
                    <button onClick={() => toggleClientActive(c.id, c.is_active)} style={{
                      background: c.is_active ? "#ef444422" : "#00d4aa22",
                      border: `1px solid ${c.is_active ? "#ef4444" : "#00d4aa"}`,
