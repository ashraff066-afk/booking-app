...
<div style={{ background: COLORS.surface, borderRadius: 12, padding: 14, marginBottom: 20, border: `1px solid ${COLORS.border}` }}>
  ...
  <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 10 }}>
    <div>
      <label style={{ display: "block", fontSize: 11, color: COLORS.muted, marginBottom: 4 }}>من</label>
<select value={eveningStart} onChange={e => { setEveningStart(e.target.value); setEveningEnabled(true); }} style={{ width: "100%", padding: "10px 12px", borderRadius: 10, background: COLORS.card, border: `1px solid ${COLORS.border}`, color: COLORS.text, fontSize: 13, outline: "none", fontFamily: "Tajawal,sans-serif" }}><option value="">اختر</option><option value="12:00">12:00 ظهر</option><option value="13:00">1:00 مساء</option><option value="14:00">2:00 مساء</option><option value="15:00">3:00 مساء</option><option value="16:00">4:00 مساء</option><option value="17:00">5:00 مساء</option><option value="18:00">6:00 مساء</option><option value="19:00">7:00 مساء</option><option value="20:00">8:00 مساء</option><option value="21:00">9:00 مساء</option><option value="22:00">10:00 مساء</option><option value="23:00">11:00 مساء</option></select>
    </div>
    <div>
      <label style={{ display: "block", fontSize: 11, color: COLORS.muted, marginBottom: 4 }}>إلى</label>
     <select value={eveningEnd} onChange={e => { setEveningEnd(e.target.value); setEveningEnabled(true); }} style={{ width: "100%", padding: "10px 12px", borderRadius: 10, background: COLORS.card, border: `1px solid ${COLORS.border}`, color: COLORS.text, fontSize: 13, outline: "none", fontFamily: "Tajawal,sans-serif" }}><option value="">اختر</option><option value="13:00">1:00 مساء</option><option value="14:00">2:00 مساء</option><option value="15:00">3:00 مساء</option><option value="16:00">4:00 مساء</option><option value="17:00">5:00 مساء</option><option value="18:00">6:00 مساء</option><option value="19:00">7:00 مساء</option><option value="20:00">8:00 مساء</option><option value="21:00">9:00 مساء</option><option value="22:00">10:00 مساء</option><option value="23:00">11:00 مساء</option><option value="00:00">12:00 منتصف الليل</option></select>
    </div>
  </div>
